...
```{r data-gather, out.extra='style="border: none;"', fig.cap = "Density Map: Light Blue for Non-Superfund, Dark Blue for Superfund Sites"}
 knitr::include_app("https://caitlinlambert.shinyapps.io/density_plot/?_ga=2.38362147.1631051593.1638490448-542459212.1632238530", height = "500px")
```
...
We were interested in whether two word were included in the same research abstract. We did not give extra weight to connections that occured multiple times in the same research abstract. Thus, when computing data for our network, we only considered whether or not a connection shows up at least one time in each research abstract. The weights for our edges thus reflect the number of abstracts that contain two individual words. 
