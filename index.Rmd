...
In order to create the markers for Superfund sites, I had to join this true/false value with a separate dataset for the latitude/longtitude of the county.

```{r markers-data, echo = TRUE, eval = FALSE}
# code for data wrangling for the superfund markers
...
head(counties_markers)
```

```{r map1-code, echo = TRUE, eval = FALSE}
# code to understand the interactive map
leafletProxy("map") %>%
      clearShapes() %>%
      clearControls() %>%
...
```{r map1-visualization, out.extra='style="border: none;"', out.width='56%', fig.cap = "Leaflet Map Visualization"}
# embed shiny app once published
 knitr::include_url("https://caitlinlambert.shinyapps.io/leaflet_map_1/", height = "600px")
```
